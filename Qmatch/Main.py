...
initialPermutation = pickle.load(open("../FaustDS/Initpermutations.p", "rb"))
...
for problemInstance in [33,34]:
   ...
   #for nrWorst in [ 35,38] :
        ...
        S = scipy.io.loadmat('../../FaustDS/tr_reg_0'+str(problemInstance)+'.mat')
        ...
        T =scipy.io.loadmat('../../FaustDS/tr_reg_0'+str(problemInstance+1)+'.mat')
